...
testo di sola lettura, a differenza delle voci ancora modificabili di
quella riga (specs/56, "modificare manualmente una voce di costo prima
...
- Nella tabella "Rette" (specs/56), l'importo e la nota del
  ...
  tabella (specs/56, "retta, marca da bollo, costo pasti e
  credito/debito non sono modificabili dalla tabella"): per
  correggerla bisogna intervenire sulla scheda del bambino
