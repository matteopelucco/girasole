...
- Rette e pagamenti genitori (Fase 2) — è iniziata solo la
  configurazione dei parametri di base per bambino (vedi
  [55 - parametri-retta.md](55%20-%20parametri-retta.md)): calcolo
  dell'importo dovuto in un mese, invio del promemoria e stato
  pagamento restano fuori scope.
